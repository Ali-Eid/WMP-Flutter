...
class AppPreferences {
  ...
  String PREFS_KEY_ROLE = 'PREFS_KEY_ROLE';
  ...
  Future<void> setUserRole(bool role) async {
    _sharedPreferences.setBool(PREFS_KEY_ROLE, role);
  }

  Future<bool> getUserRole() async {
    return _sharedPreferences.getBool(PREFS_KEY_ROLE) ?? false;
  }
